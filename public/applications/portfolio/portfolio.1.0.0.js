...
const tinyColor = __webpack_require__(3);
...
const components = flattenObject({
    grid: grid_component_1.grid,
    skin: skin_component_1.skin,
    typeography: typeography_component_1.typeography,
    viewport: viewport_component_1.viewport,
    buttons: button_component_1.buttons
});
const componentsJs = {
    grid: grid_component_1.grid,
    skin: skin_component_1.skin,
...
exports.default = { components, componentsJs };
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--0-2!./button.scss", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js??ref--0-2!./button.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
const skin_component_1 = __webpack_require__(0);
//global setup
const buttonHollowVarients = true;
const buttonDefaultSize = "medium";
const buttonRoundness = skin_component_1.skin.roundness;
const buttonSizeVarients = {
    "extra-small": {
...
exports.typeography = {
    ...
    "text-color": skin_component_1.skin.appearance === "light" ? "#000" : "#fff",
...
/***/ })
/******/ ]);
//# sourceMappingURL=portfolio.1.0.0.js.map